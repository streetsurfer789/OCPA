...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(user32.GetSystemMetrics(
            0)-10, user32.GetSystemMetrics(1))  # custom
        ...
        self.tableview.setGeometry(QtCore.QRect(190, 10, user32.GetSystemMetrics(
            0) - 225, user32.GetSystemMetrics(1) - 300))  # custom
